...
## FINE-TUNED MODEL
cnn_model_A = load_model('base_model.h5')
cnn_model_B_on_A = Sequential(cnn_model_A.layers[:-4])
...
# CLASSIFICATION
# fully connected layer
cnn_model_B_on_A.add(Dense(32, activation='relu', kernel_regularizer=regularizers.l2(weight_decay)))
cnn_model_B_on_A.add(Dropout(0.5))
# output layer w/ sigmoid
cnn_model_B_on_A.add(Dense(2, activation="sigmoid"))

for layer in cnn_model_B_on_A.layers[:-4]:
    trainable = True
...
cnn_model_B_on_A.save('finetuned_model.h5')
